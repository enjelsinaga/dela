            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="tambah-data-siswa.php" class="btn btn-primary">Tambah Data Siswa</a></p>
                        <br>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if (file_exists('../../' . $data['ijazah_siswa']) && $data['ijazah_siswa'] != null) : ?>
                                                    <a href="<?= '../../' . $data['ijazah_siswa']; ?>" target="_blank" class="btn btn-success btn-sm" title="Lihat File"><i class="bi bi-file-earmark-text"></i></a>
                                                <?php else : ?>
                                            ...
                                            <td class="text-center">
                                                <?php if (file_exists('../../' . $data['penghargaan']) && $data['penghargaan'] != null) : ?>
                                                    <a href="<?= '../../' . $data['penghargaan']; ?>" target="_blank" class="btn btn-success btn-sm" title="Lihat File"><i class="bi bi-file-earmark-text"></i></a>
                                                <?php else : ?>
                                                    <span class="badge bg-danger">File Tidak Ditemukan</span>
                                                <?php endif; ?>
                                            </td>
