                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if (file_exists('../../' . $data['ijazah_calon']) && $data['ijazah_calon'] != null) : ?>
                                                    <a href="<?= '../../' . $data['ijazah_calon']; ?>" target="_blank" class="btn btn-success btn-sm" title="Lihat File"><i class="bi bi-file-earmark-text"></i></a>
                                                <?php else : ?>
