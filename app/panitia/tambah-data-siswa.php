...
if (isset($_POST['submit'])) {
    ...
    // mysqli_query($conn, "INSERT INTO `tabel-siswa`(id_siswa , nama_lengkap, umur_siswa, no_ortu_siswa, ijazah_siswa , KTP_ortu, KK, akteLahir , penghargaan ) 
    //                         VALUES ('id_siswa', '$nama_lengkap', $umur_siswa,'$no_ortu_siswa', '$ijazah_siswa', '$KTP_ortu', '$KK',  '$akteLahir ', '$penghargaan ') 
    ...
    if ($status_file_upload_ijazah && $status_file_upload_ktp_ortu && $status_file_upload_kk && $status_file_upload_akte_lahir && $status_file_upload_penghargaan) {
        mysqli_query($conn, "INSERT INTO `tabel-siswa`(nama_lengkap, jenis_kelamin, umur_siswa, no_ortu_siswa, ijazah_siswa , KTP_ortu, KK, akteLahir , penghargaan, created_at, updated_at ) 
                            VALUES ('$nama_lengkap', '$jenis_kelamin', $umur_siswa, '$no_ortu_siswa', '$file_save_ijazah_siswa', '$file_save_KTP_ortu', '$file_save_KK',  '$file_save_akteLahir', '$file_save_penghargaan', '$waktu_sekarang', '$waktu_sekarang')
                          ") or die(mysqli_error($conn));
