<?php 
  ...
  include('../_sidebar.php');
    ...
    if (!isset($_GET['id-transaksi'])) {
      echo"<script>window.location='dana-masuk.php'</script>";
  }
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Edit Dana Masuk</h5>
  ...
  if (isset($_POST['edit'])) 
  {
    ...
    // Lalu ubah data yang ada didatabase sesusai hasil inputan
     ...
     if (mysqli_affected_rows($conn) > 0) {
       ...
       echo"<script>alert('Transaksi berhasil diedit');window.location='dana-masuk.php'</script>";
     }
     else{
