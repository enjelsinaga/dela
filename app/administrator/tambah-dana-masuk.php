    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Tambah Dana Masuk</h5>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-8">
                          ...
                          <?php  
                              ...
                              $querykategori = mysqli_query($conn, "SELECT * FROM tabel_kategori WHERE jenis = 'Dana masuk' " ) or die (mysqli_error($conn));  
                              // Looping data nya
...
<?php 
  ...
  if (isset($_POST['submit'])) {
   ...
   if (mysqli_affected_rows($conn) > 0) {
     echo"<script>alert('Transaksi dana masuk berhasil ditambahkan');window.location='dana-masuk.php'</script>";
   }
   else{
    echo"<script>alert('Transaksi dana masuk gagal ditambahkan!');</script>"; 
   }
