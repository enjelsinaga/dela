    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Transaksi Dana Keluar</h5>
                <p class="card-text"><a href="tambah-dana-keluar.php" class="btn btn-primary">Tambah dana keluar</a></p>
                <br>
...
?>                      
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="edit-dana-keluar.php?id-transaksi=<?= $data['id_transaksi']; ?>" class="btn btn-sm btn-warning" title="Edit"><i class="bi bi-pencil"></i></a>
                          <a href="hapus-dana-keluar.php?id-transaksi=<?= $data['id_transaksi']; ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')"><i class="bi bi-trash"></i></a>
                        </td>
                      </tr>  
