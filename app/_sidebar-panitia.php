...
<aside id="sidebar" class="sidebar ">
    <ul class="sidebar-nav " id="sidebar-nav">
        ...
        <ul id="pengelolaan-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <!-- <li class="nav-item">
              <?php if( $page == "Cetak Laporan Kas") { ?>
                  <a class="nav-link " href="laporan-kas.php">
                      <i class="bi bi-printer"></i>
                      <span>Cetak Laporan Kas</span>
                  </a>
              <?php } else { ?>
                  <a class="nav-link collapsed" href="laporan-kas.php">
                      <i class="bi bi-printer"></i>
                      <span>Cetak Laporan Kas</span>
                  </a>
              <?php } ?>
          ...
          <!-- <li class="nav-item">
              <?php if( $page == "Profil Instansi") { ?>
                  <a class="nav-link " href="profil-instansi.php">
                      <i class="bi bi-bank"></i>
                      <span>Profil Instansi</span>
                  </a>
              <?php } else { ?>
                  <a class="nav-link collapsed" href="profil-instansi.php">
                      <i class="bi bi-bank"></i>
                      <span>Profil Instansi</span>
                  </a>
              <?php } ?>
          </li> -->
          <!-- End Profil Instansi Nav --> 
